...
shared_data = insta_scraper.get_shared_data_userinfo(username='dprlive')
shared_data = insta_scraper.get_shared_data_userinfo(username='chingooz')


insta_scraper.usernames.append("dprlive")
insta_scraper.usernames.append("chingooz")
...
class GetInstagramProfile():
    def __init__(self) -> None:
        ...
        self.L.login('gramy.scrape', 'insta$8scrape')
